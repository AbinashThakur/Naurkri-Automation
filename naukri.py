...
originalResumePath = "C:\\Users\\MANISH\\abinash\\Original-CV\\01_Abinash_Resume_CV.pdf"
# Add Path where modified resume should be saved
modifiedResumePath = "C:\\Users\\MANISH\\abinash\\Modified-CV\\01_Abinash_Resume_CV.pdf"

# Update your naukri username and password here before running
username = "abhi.vj69@gmail.com"
password = "9867798781"
mob = "9867798781"  # Type your mobile number here
...
def main():
    log_msg("-----Naukri.py Script Run Begin----- %s" % datetime.now())
    driver = None
    try:
    ...
    log_msg("-----Naukri.py Script Run Ended-----%s \n" % datetime.now())
